...
<?php
    ...
    public function getBalanceSheet()
    {
        ...
        try {
            ...
            $bad_debts_customer_payment = $this->db->query("SELECT SUM(CPayment_discount) as total_bad_debt
                FROM tbl_customer_payment
                WHERE CPayment_status = 'a'
                and CPayment_date < '$date'
                and CPayment_brunchid = ?", $this->brunch)->row();
            ...
            $statements = [
                ...
                'bad_debts'         => $bad_debts + $bad_debts_customer_payment->total_bad_debt,

...
class Transfer extends CI_Controller
{
    ...
    public function addProductTransfer()
    {
        ...
        try {
            ...
            $res = ['success' => true, 'message' => 'Transfer done successfully'];
        } catch (Exception $ex) {
    ...
    public function getTransfers()
    {
        ...
        $transfers = $this->db->query("SELECT tm.*,b.Brunch_name as transfer_from_name,b2.Brunch_name as transfer_to_name
                from tbl_transfermaster tm
                left join tbl_brunch b on b.brunch_id = tm.transfer_from
                left join tbl_brunch b2 on b2.brunch_id = tm.transfer_to
    ...
    public function transferInvoice($transferId)
    {
        ...
        $data['transfer'] = $this->db->query("
                select
                    tm.*,
                    b.Brunch_name as transfer_from_name,
                    b2.Brunch_name as transfer_to_name
                from tbl_transfermaster tm
                join tbl_brunch b on b.brunch_id = tm.transfer_from
                join tbl_brunch b2 on b2.brunch_id = tm.transfer_to

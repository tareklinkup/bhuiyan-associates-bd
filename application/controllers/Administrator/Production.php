    ...
    public function addProduction(){
        ...
        try{
            ...
            foreach($data->products as $product){
                ...
                $previousStock = $this->mt->productStock($product->product_id,$this->sbrunch);
    ...
    public function updateProduction(){
        ...
        try{
            ...
            foreach($oldProducts as $oldProduct){
                $previousStock = $this->mt->productStock($oldProduct->product_id, $this->session->userdata('BRANCHid'));
            ...
            foreach($data->products as $product){
                ...
                $this->db->insert('tbl_production_products', $productionProduct);
                $previousStock = $this->mt->productStock($product->product_id, $this->session->userdata('BRANCHid'));

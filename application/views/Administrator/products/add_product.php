	...
	<form @submit.prevent="saveProduct">
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom: 15px;">
			<div class="col-md-5 col-md-offset-1">
				...
				<div class="form-group clearfix">
					<label class="control-label col-md-4">Convert qty:</label>
					<div class="col-md-7">
						<input type="number" class="form-control" v-model="product.convert_qty">
					</div>
				</div>
				<div class="form-group clearfix">
					<label class="control-label col-md-4">Convert to Name:</label>
					<div class="col-md-7">
						<input type="text" class="form-control" v-model="product.convert_to_name">
					</div>
				</div>
			</div>

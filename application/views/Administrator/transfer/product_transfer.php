                        ...
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <div class="form-group clearfix">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" value="<?= $this->session->userdata('Brunch_name') ?>"
    ...
    methods: {
        ...
        async getBranches() {
            await axios.get('/get_branches').then(res => {
                let currentBranchId = parseInt(
                    "<?php echo $this->session->userdata('BRANCHid'); ?>");
                ...
                if (isBranch) {
                    this.branches = res.data.filter((obj) => {
                        return ((obj.MainBranch_Id == currentBranchId || (obj
                            .MainBranch_Id == null && obj.brunch_id !=
                            currentBranchId)) && obj.active_status == 'Active')
                    });
                } else {
                    this.branches = res.data.filter((obj) => {
                        return (obj.brunch_id == mainBranch && obj.active_status ==
                            'Active')
                    });

                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            ...
                            <div class="form-group clearfix">
                                <label class="col-sm-4 control-label no-padding-right" style="margin-top: 20px;font-weight:bold">SHIP TO: </label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" v-model="sales.shipping_cus_name" required />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 control-label no-padding-right"> Driver </label>
                                <div class="col-sm-7">
                                    <v-select v-bind:options="drivers" label="name" v-model="selectedDriver"></v-select>
                                </div>
                                <div class="col-xs-1" style="padding: 0;">
                                    <a href="<?= base_url('driver') ?>" class="btn btn-xs btn-danger" style="height: 25px; border: 0; width: 27px; margin-left: -10px;" target="_blank" title="Add New Customer"><i class="fa fa-plus" aria-hidden="true" style="margin-top: 5px;"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-5">
                            <form v-on:submit.prevent="addToCart">
                                ...
                                <div class="form-group" style="display: none;">
                                    ...
                                    <div class="col-xs-4">
                                        <input type="number" id="ProductDiscountPercent" placeholder="%" step="0.01" min="0.00" class="form-control" v-model="Product_DiscountPercent" v-on:input="productTotal" />
                                    </div>
                                    <div class="col-xs-1 no-padding">Tk.</div>
                                    <div class="col-xs-4">
                                        <input type="number" id="ProductDiscountTaka" placeholder="Taka" step="0.01" min="0.00" class="form-control" v-model="selectedProduct.Product_DiscountTaka" v-on:input="productTotal" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-xs-3 control-label no-padding-right"> Quantity </label>
                                    <div class="col-xs-4">
                                        <input type="number" step="0.01" min="0" id="quantity" placeholder="" class="form-control" ref="quantity" v-model="selectedProduct.quantity" v-on:input="productTotal" autocomplete="off" required />
                                    </div>
                                    <label id="convert_quantity_name" class="col-xs-2 no-padding text-right"> </label>
                                    <div class="col-xs-3 no-padding-left">
                                        <input type="number" step="0.01" min="0" id="convert_quantity" placeholder="" class="form-control" ref="convert_quantity" v-model="selectedProduct.convert_quantity" v-on:input="productTotal" autocomplete="off" required />
                                    </div>
                                </div>
                ...
                <table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
                    ...
                    <tbody style="display:none;" v-bind:style="{display: cart.length > 0 ? '' : 'none'}">
                        <tr v-for="(product, sl) in cart">
                            ...
                            <td>
                                <input style="width: 60px;text-align:center;" type="number" step="0.01" min="0" v-on:input.prevent="updateCart(product)" v-model="product.quantity">
                            </td>
                            <td>
                                <input style="width: 120px;text-align:center;" type="number" step="0.01" min="0" v-on:input.prevent="updateCart(product)" v-model="product.salesRate">
                            </td>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <label class="col-xs-12 control-label no-padding-right">Lifting/Loading
                                                    Cost</label>
                                                <div class="col-xs-12">
                                                    <input type="number" class="form-control" v-model="sales.loadingCost" v-on:input="calculateTotal" />
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
        ...
        methods: {
            ...
            updateCart(data) {
                this.cart.forEach(ele => {
                    if (ele.id == data.id) {
                        ele.total = ele.quantity * ele.salesRate;
                    }
                })
                this.calculateTotal();
            },
            ...
            async getSales() {
                await axios.post('/get_sales', {
                    ...
                    // this.selectedDriver = this.drivers.find(i => i.id == sales.driver_id)
                    this.selectedDriver = {
                        id: sales.driver_id,
                        name: sales.name,
                        phone: sales.phone

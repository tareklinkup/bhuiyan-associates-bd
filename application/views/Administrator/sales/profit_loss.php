                ...
                <table id="table1">
                    ...
                    <tbody v-for="data in reportData">
                        <tr>
                            <td colspan="7" style="background-color: #e3eae7;">
                                ...
                                <strong>Lifing/Loading Cost: </strong> {{ data.SaleMaster_loadingCost | decimal }}
                            </td>
                        </tr>
                    ...
                    <tfoot style="font-weight:bold;background-color:#e9dcdc;">
                        ...
                        <tr>
                            ...
                            <td colspan="2"></td>
                            <td style="text-align:right;">{{ totalDiscountCost }}</td>
...
new Vue({
    ...
    computed: {
        totalDiscountCost() {
            let saleDiscount = this.reportData.reduce((prev, cur) => {
                return prev + parseFloat(cur.SaleMaster_TotalDiscountAmount)
            }, 0).toFixed(2);

            return parseFloat(parseFloat(saleDiscount) + parseFloat(this.otherIncomeExpense.bad_debt_amount))
                .toFixed(2)
        },
        totalTransportCost() {
        ...
        totalLoadingCost() {
            return this.reportData.reduce((prev, cur) => {
                return prev + parseFloat(cur.SaleMaster_loadingCost)
            }, 0).toFixed(2);
        },
        otherIncome() {
            return (
                (
                    ...
                    parseFloat(this.totalLoadingCost) +
                    ...
                    parseFloat(this.otherIncomeExpense.purchase_loading_cost)
                )
            ).toFixed(2);
        }
    },

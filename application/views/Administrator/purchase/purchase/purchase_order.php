                        ...
                        <div class="col-sm-6">
                            <form v-on:submit.prevent="addToCart">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-3">
                                        <input type="number" id="ProductDiscountPercent" placeholder="%" step="0.01" min="0.00" class="form-control" v-model="productDiscountPercent" v-on:input="productTotal" />
                                    </div>
                                    <div class="col-xs-1 no-padding">Tk.</div>
                                    <div class="col-xs-4">
                                        <input type="number" id="ProductDiscountTaka" placeholder="Taka" step="0.01" min="0.00" class="form-control" v-model="selectedProduct.discount" v-on:input="productTotal" />
                                    </div>
                                </div>
...
new Vue({
    ...
    methods: {
        ...
        // },
        productTotal() {
            this.selectedProduct.discount = this.selectedProduct.discount ?? 0;
            if (event.target.id == 'ProductDiscountPercent') {
                this.selectedProduct.discount = ((+this.selectedProduct.total * +this.productDiscountPercent) / 100).toFixed(2);
            } else {
                this.productDiscountPercent = ((+this.selectedProduct.discount * 100) / +this.selectedProduct.total).toFixed(2);
            }
            ...
            if (this.selectedProduct.Product_SlNo != '') {
                ...
                this.selectedProduct.total = ((+totalQty * +this.selectedProduct.Product_Purchase_Rate) - +this.selectedProduct.discount);
            }
        },
        addToCart() {
            ...
            let product = {
                ...
                discount: this.selectedProduct.discount ?? 0
            }

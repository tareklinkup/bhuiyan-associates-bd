                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <v-select label="display_text" v-bind:options="materials" v-on:input="setFocus"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="materialName" name="materialName"
                                                placeholder="Raw Material Name" class="form-control" readonly v-model="selectedMaterial.name"/>
                                        </div>
                                    </div>
                    ...
                    <table class="table table-bordered" cellspacing="0" cellpadding="0"
                        ...
                        <tbody style="display:none;" v-bind:style="{display: cart.length > 0 ? '' : 'none'}">
                            <tr v-for="(material, sl) in cart">
                                ...
                                <td>{{ parseFloat(material.purchase_rate).toFixed(2) }}</td>

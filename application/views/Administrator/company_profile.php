			...
			<div id="branch">
				<div class="row" style="margin-top: 15px;">
					<div class="col-md-12" style="margin-bottom: 10px;">
						<div class="form-group">
							<label class="col-sm-3 control-label" style="text-align: right; padding-right:5px;">Create Type</label>
							<label class="col-sm-1 control-label" style="text-align: right; padding-right:5px;">:</label>
							<div class="radio inline-radio" style="padding:0 10px;">
								<label>
									<input v-model="creatType" id="branch" type="radio" value="branch" />
									<span class="lbl"> Branch</span>
								</label>
							</div>
							<div class="radio inline-radio">
								<label>
									<input v-model="creatType" id="branch" type="radio" value="warehouse" />
					...
					<div class="col-md-12">
						<form class="form-horizontal" @submit.prevent="saveBranch">
							<div v-if="creatType == 'warehouse'" class="form-group">
								<label class="col-sm-3 control-label no-padding-right"> Select Branch </label>
								<label class="col-sm-1 control-label no-padding-right">:</label>
								<div class="col-sm-8">
									<select v-model="branch.mainBranchId" id="" class="form-control no-padding" style="border-radius: 4px;">
...
<script>
	new Vue({
		...
		computed: {
			onlyBranch() {
				return this.branches.filter(b => b.MainBranch_Id == null && b.status == 'a');
			}
		},
		methods: {
			getBranches() {
			...
			saveBranch() {
				...
				// console.log(this.onlyBranch, this.creatType);
				// return;
			...
			editBranch(branch) {
				this.branch.mainBranchId = branch.MainBranch_Id;
				...
				if (branch.MainBranch_Id == null) {
					this.creatType = 'branch'
				} else {
					this.creatType = 'warehouse'
				}
			},

                        ...
                        <table _a584de>
                            ...
                            <tbody>
                                <tr v-for="(product, sl) in cart">
                                    ...
                                    <td> {{ Math.floor(product.SaleDetails_TotalQuantity / parseInt(product.convert_qty)) }} {{ product.convert_to_name }}, {{ product.SaleDetails_TotalQuantity % parseInt(product.convert_qty) }} {{ product.Unit_Name }}</td>
